...
constructor TAcsSampleConverter.Create(AOwner: TComponent);
begin
  inherited Create(AOwner);
end;
...
procedure TAcsStereoBalance.SetBalance(AValue: Single);
begin
  if (AValue >= 0) and (AValue <=1) then FBalance:=AValue;
end;
